...
public class AIPerformance {
    ...
    public static final int MAX_N_GUESSES = 30;

	static void printAllResults(List<IStrategy> strategies, Map<IStrategy, AIStatistics> stats) {
		System.out.println(
                "---------------------------------------------------------------------------------------------\n");
	...
	static Map<IStrategy, AIStatistics> runAll(List<IStrategy> strategies,Dictionary dictionary) {
	...
	static List<IStrategy> getStrategies(Dictionary dictionary) {
     ...
     */
    public static AIStatistics runWordleGames(IStrategy strategy, Dictionary dictionary) {
        ...
        for (int i = 0; i < N_GAMES; i++) {
            try {
                WordleAnswer answer = new WordleAnswer(dictionary);
