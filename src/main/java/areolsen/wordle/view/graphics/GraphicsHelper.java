...
public final class GraphicsHelper {
  ...
  public static void enableSmoothRendering(Graphics2D g2) {
      // Enable anti-aliasing for text
      g2.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING,
                         RenderingHints.VALUE_TEXT_ANTIALIAS_ON);

      // Enable anti-aliasing for shapes (circles, rectangles, etc.)
      ...
      // Enable fractional metrics for better text positioning
      g2.setRenderingHint(RenderingHints.KEY_FRACTIONALMETRICS,
                         RenderingHints.VALUE_FRACTIONALMETRICS_ON);

      // Optional: Enable text LCD contrast for better readability on LCD screens
  ...
  public static void drawCenteredString(Graphics g, String s, Point2D p) {
    GraphicsHelper.drawCenteredString(g, s, p.getX(), p.getY());
  }
  ...
  public static void drawCenteredString(Graphics g, String s, Shape shape) {
    GraphicsHelper.drawCenteredString(g, s, shape.getBounds2D().getCenterX(),
  ...
  public static void drawImage(Graphics g, Image image, double x, double y,
                               double scale) {
    GraphicsHelper.drawImage(g, image, x, y, scale, 0);
  }
  ...
  public static void drawCenteredImage(Graphics g, Image image, double cx, double cy,
                                       double scale) {
    GraphicsHelper.drawCenteredImage(g, image, cx, cy, scale, 0);
  }
  ...
  public static BufferedImage loadImageFromResources(String filename) {
    ...
    InputStream is = GraphicsHelper.class.getResourceAsStream(filename);
    if (is == null) {
