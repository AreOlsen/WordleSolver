...
public class WordList {
	 ...
	 * GetWords class.
	 */
	public WordList(Dictionary dictionary) {
	 ...
	 * @param feedback
	 */
	public void eliminateWords(Word feedback) {
		LinkedList<String> newPossibleAnswers = new LinkedList<>();
		for(String word : possibleAnswers){
			if(Word.isPossibleWord(word, feedback)){
				newPossibleAnswers.addLast(word);
			}
		}
